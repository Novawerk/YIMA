...
| 概览 | 月历详情 | 统计 | 设置 |
|---|---|---|---|
| ![概览](docs/screenshots/android/01-overview-zh.png) | ![月历详情](docs/screenshots/android/02-detail-zh.png) | ![统计](docs/screenshots/android/03-statistics-zh.png) | ![设置](docs/screenshots/android/04-settings-zh.png) |
