...
| 概览 | 月历详情 | 统计 | 提醒 | 设置 |
|---|---|---|---|---|
| ![概览](docs/screenshots/android/01-overview-zh.png) | ![月历详情](docs/screenshots/android/02-detail-zh.png) | ![统计](docs/screenshots/android/03-statistics-zh.png) | ![提醒](docs/screenshots/android/04-reminder-zh.png) | ![设置](docs/screenshots/android/05-settings-zh.png) |

_Android 1.5.0 中文界面。统计图展示的是引导阶段自动生成的 5 个周期历史。_
