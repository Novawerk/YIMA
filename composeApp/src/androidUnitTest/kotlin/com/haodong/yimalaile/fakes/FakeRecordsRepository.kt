 ...
 * Returns 6 period records spanning ~6 months with varying durations,
...
// Pattern 1: Light → Heavy → Medium → Light
...
// Pattern 3: Heavy → Medium → Light → Light
